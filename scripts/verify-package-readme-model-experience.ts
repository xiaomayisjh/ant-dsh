...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/bundle/ant-sword-harness': { kind: 'indirect', reason: 'The bundle is a patch-list carrier plus a bundled skill provider; each inserted row\'s package and the dsh-skill/tool-skill consumers own the model-facing rendering of the contributed skills.' },
